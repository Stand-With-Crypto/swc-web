...
describe('page - politician details', () => {
  ...
  it('page with questionnaire', () => {
    ...
    cy.get('button[data-testid="questionnaire-trigger"]')
      .as('questionnaireTrigger')
      .should('be.visible')
      .click()

    cy.get('[data-testid="q1ExperienceUsingBlockchainTechnology"]')
      .should(
        'contain',
        'Do you have experience buying, selling, or using blockchain technology assets or investment tools?',
      )
    ...
    cy.get('[data-testid="q2BlockchainWillPlayMajorRoleNextInnoWave"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q3AmerCryptoIsDrivingEconomicGrowth"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q4UsCompAtRiskIfDigitalAssetsPushedOverse"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q5UsModernizeRegulatoryEnvironmentForCrypto"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q6WouldYouVoteInFavorOfLegislation"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q7VoteInFavorOfLegisToPaymentStablecoins"]')
      .should(
        'contain',
    ...
    cy.get('[data-testid="q8ShareAnyOtherOpinionsOnCrypto"]')
      .should(
        'contain',
