...
type GBNFTArrivedEmailProps = KeepUpTheFightSectionProps &
  GBEmailTemplateProps & {
    actionNFT: keyof typeof GB_NFT_IMAGES_BY_ACTION
  }

const GBNFTArrivedEmail = ({
  previewText,
  session = {},
  hrefSearchParams = {},
  ...
  actionNFT = 'OPT_IN',
  ...keepUpTheFightSectionProps
}: GBNFTArrivedEmailProps) => {
  const hydratedHrefSearchParams = {
    utm_campaign: GBNFTArrivedEmail.campaign,
    ...hrefSearchParams,
    ...session,
  }
...
GBNFTArrivedEmail.subjectLine = 'Your NFT has arrived!'
GBNFTArrivedEmail.campaign = 'nft_arrived'

export default GBNFTArrivedEmail
