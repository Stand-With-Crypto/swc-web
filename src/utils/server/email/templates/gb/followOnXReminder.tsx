    ...
    <Wrapper hrefSearchParams={hydratedHrefSearchParams} previewText={previewText}>
      <Section>
        ...
        <Text className="text-foreground-muted text-center text-base">
          We're so grateful for our Stand With Crypto community members in the UK, and we want to
          ...
          awesome discussion Spaces that we host with advocates and founders across the United
          Kingdom.
          <br />
          <br />
          <Link className="text-inherit underline" href={GB_SOCIAL_MEDIA_URL.twitter}>
