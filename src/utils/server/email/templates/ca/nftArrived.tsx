...
type CANFTArrivedEmailProps = KeepUpTheFightSectionProps &
  CAEmailTemplateProps & {
    actionNFT: keyof typeof CA_NFT_IMAGES_BY_ACTION
  }

const CANFTArrivedEmail = ({
  previewText,
  session = {},
  hrefSearchParams = {},
  ...
  const hydratedHrefSearchParams = {
    utm_campaign: CANFTArrivedEmail.campaign,
    ...hrefSearchParams,
    ...session,
  }
...
CANFTArrivedEmail.subjectLine = 'Your NFT has arrived!'
CANFTArrivedEmail.campaign = 'nft_arrived'

export default CANFTArrivedEmail
