    ...
    <CAWrapper hrefSearchParams={hydratedHrefSearchParams} previewText={previewText}>
      <Section>
        ...
        <Text className="text-foreground-muted text-center text-base">
          We're so grateful for our Stand With Crypto community members in Canada, and we want to
          ...
          awesome discussion Spaces that we host with advocates and founders across Canada.
          <br />
          <br />
          <Link className="text-inherit underline" href={CA_SOCIAL_MEDIA_URL.twitter}>
            Follow us on X
