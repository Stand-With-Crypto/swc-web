...
type FinishSettingUpProfileReminderEmailProps = KeepUpTheFightSectionProps & AUEmailTemplateProps

const AUFinishSettingUpProfileReminderEmail = ({
  previewText,
  session = {},
  hrefSearchParams = {},
  ...keepUpTheFightSectionProps
  ...
  const hydratedHrefSearchParams = {
    utm_campaign: AUFinishSettingUpProfileReminderEmail.campaign,
    ...hrefSearchParams,
    ...session,
  }
    ...
    <Wrapper hrefSearchParams={hydratedHrefSearchParams} previewText={previewText}>
      <Section>
        ...
        <Text className="text-foreground-muted text-center text-base">
          Thank you for signing up to be a Stand With Crypto Australia advocate. As a reminder,
          please take just a few moments to finish setting up your full profile with SWC.
          <br />
          <br />
...
AUFinishSettingUpProfileReminderEmail.subjectLine = 'Finish setting up your profile'
AUFinishSettingUpProfileReminderEmail.campaign = 'finish_setting_up_profile'

export default AUFinishSettingUpProfileReminderEmail
