    ...
    <AUWrapper hrefSearchParams={hydratedHrefSearchParams} previewText={previewText}>
      <Section>
        ...
        <Heading gutterBottom="md">
          Get text updates on crypto policy and invites to Australian events
        </Heading>

        <Text className="text-foreground-muted text-center text-base">
          Thank you for signing up to be a Stand With Crypto advocate in Australia. We're reaching
          out to encourage you to take your advocacy to the next level by adding a phone number to
          receive text messages from SWC.
          <br />
          <br />
          You'll receive updates on key crypto bills, exclusive events in Australia, and
