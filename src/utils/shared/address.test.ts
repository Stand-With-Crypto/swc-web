...
describe('getFormattedDescription', () => {
  it.each([
    ...
    expect(getFormattedDescription(input, true)).toEqual(expected)
  })
})

describe('getFormattedDescription without postalCodeSuffix', () => {
  it.each([
    [
      {
        streetNumber: '',
    ...
    [
      ...
      'LYNN LN, STARKVILLE MS, 12345 US',
    ],
    [
      {
        streetNumber: '110',
      ...
      '110 LYNN LN, STARKVILLE MS, 12345 US',
    ],
    [
      {
        streetNumber: '110',
      ...
      '110 LYNN LN APT 338, STARKVILLE MS, 12345 US',
    ],
    [
      {
        streetNumber: '110',
    ...
    expect(getFormattedDescription(input, false)).toEqual(expected)
  })
})
