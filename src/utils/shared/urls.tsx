...
export const getIntlUrls = (
  ...
  return {
    ...
    locationUnitedStatesPresidential: () => `${localePrefix}/locations/us/presidential`,
    locationUnitedStates: () => `${localePrefix}/locations/us/`,
    endorsedCandidates: () => `${localePrefix}/endorsed/`,
