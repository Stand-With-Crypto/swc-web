...
> = {
  EMAIL: {
    image: `${BASE_URL}/actionTypeIcons/email.png`,
  ...
  VOTER_REGISTRATION: {
    image: `${BASE_URL}/actionTypeIcons/registerToVote.png`,
    text: 'Register to vote',
    subtext: 'Check your voter registration status and get a free NFT by pplpleasr.',
    buttonLabel: 'Register',
    buttonHref: `${BASE_URL}/action/voter-registration`,
  },
  CALL: {
    image: `${BASE_URL}/actionTypeIcons/call.png`,
  ...
  DONATION: {
    ...
    buttonLabel: 'Donate',
    buttonHref: `${BASE_URL}/donate`,
  },
  NFT_MINT: {
    image: `${BASE_URL}/actionTypeIcons/mintNFT.png`,
    text: 'Mint your Supporter NFT',
    subtext: 'All mint proceeds are donated to the movement.',
    buttonLabel: 'Mint',
    buttonHref: `${BASE_URL}/action/nft-mint`,
  },
}
