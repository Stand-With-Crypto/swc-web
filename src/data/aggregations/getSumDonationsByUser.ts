...
export const getSumDonationsByUser = async (
  limit: SumDonationsByUserConfig['limit'],
  offset: SumDonationsByUserConfig['offset'] = 0,
) => {
  console.log('EXECUTING', { limit, offset })
