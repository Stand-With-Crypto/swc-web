...
import { GBUserActionVoterAttestationCampaignName } from '@/utils/shared/userActionCampaigns/gb/gbUserActionCampaigns'
...
export const GB_VOTER_GUIDE_CTAS: VoterGuideStep[] = [
  {
    ...
    campaignName: GBUserActionVoterAttestationCampaignName['H1_2025'],
