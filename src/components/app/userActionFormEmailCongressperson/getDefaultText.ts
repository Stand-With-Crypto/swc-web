...
export function getEmailBodyText(props?: GetTextProps & { address?: string }) {
  ...
  return `${props?.firstName ? `My name is ${props.firstName}, and ` : ''}I am one of your constituents. As the new administration takes office this week, I’m writing to encourage you to partner with President Trump to advance our community’s interests in Washington.\n\nI am one of the tens of millions of Americans who own, build, or develop with cryptocurrencies and blockchain technology. I am hopeful that you will keep my views – and those of my fellow crypto owners – in mind as you work with the newly sworn-in administration and advance new legislation.\n\nAmerican crypto owners are a diverse and bipartisan group who are looking to Washington to provide clear rules of the road around crypto, including consumer protection, “market structure” legislation, stablecoin legislation, exploring the establishment of a national strategic reserve of cryptocurrency, and clarity related to tax treatment.\n\nWith the right rules from the new administration and the 119th Congress, crypto can thrive in our country, creating jobs and fostering innovation along the way. This administration and Congress are the most pro-crypto in history, and American crypto voters are excited to see what you can deliver together.\n\nThank you for taking the time to read my letter.${isUserInfoProvided ? fullNameSignOff : ''}${props?.address ? `\n${props.address}` : ''}`
}
