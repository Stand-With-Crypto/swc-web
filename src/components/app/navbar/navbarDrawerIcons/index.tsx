...
export function PollIcon({ height = 24, width = 24, ...rest }: IconProps) {
  return (
    ...
    >
      <path
        d="M2.66602 21.3337H21.3327V2.66699H2.66602V21.3337ZM15.9993 13.3337H18.666V18.667H15.9993V13.3337ZM10.666 5.33366H13.3327V18.667H10.666V5.33366ZM5.33268 9.33366H7.99935V18.667H5.33268V9.33366Z"
        fill="#00A9DD"
        opacity="0.3"
      />
      <path
        d="M21.3333 0H2.66667C1.2 0 0 1.2 0 2.66667V21.3333C0 22.8 1.2 24 2.66667 24H21.3333C22.8 24 24 22.8 24 21.3333V2.66667C24 1.2 22.8 0 21.3333 0ZM21.3333 21.3333H2.66667V2.66667H21.3333V21.3333ZM5.33333 9.33333H8V18.6667H5.33333V9.33333ZM10.6667 5.33333H13.3333V18.6667H10.6667V5.33333ZM16 13.3333H18.6667V18.6667H16V13.3333Z"
        fill="#00A9DD"
      />
    </svg>
  )
