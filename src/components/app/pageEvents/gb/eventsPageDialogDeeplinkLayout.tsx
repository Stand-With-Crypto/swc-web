...
import { GBEventsPage, GBEventsPageProps } from '@/components/app/pageEvents/gb'
import {
  dialogCloseStyles,
  dialogContentStyles,
  dialogOverlayStyles,
...
interface EventsPageDialogDeeplinkLayout extends Omit<GBEventsPageProps, 'isDeepLink'> {
...
export async function EventsPageDialogDeeplinkLayout({
  ...
  return (
    <>
      ...
      <GBEventsPage events={events} isDeepLink />
    </>
  )
}
