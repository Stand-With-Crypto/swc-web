...
import { USEventsPage, USEventsPageProps } from '@/components/app/pageEvents/us'
import {
  dialogCloseStyles,
  dialogContentStyles,
  dialogOverlayStyles,
...
interface EventsPageDialogDeeplinkLayout extends Omit<USEventsPageProps, 'isDeepLink'> {
...
export async function EventsPageDialogDeeplinkLayout({
  ...
  return (
    <>
      ...
      <USEventsPage events={events} isDeepLink />
    </>
  )
}
