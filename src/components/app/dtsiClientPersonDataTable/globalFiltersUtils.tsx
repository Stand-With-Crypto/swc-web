...
export function GlobalFilters({
  ...
  return (
    <div className="flex gap-2 overflow-x-auto pb-3 pr-3 pt-3 md:pb-0 md:pr-0 md:pt-0">
      ...
      >
        <SelectTrigger data-e2e="stance-filter-trigger" className="w-[195px] flex-shrink-0">
      ...
      >
        <SelectTrigger data-e2e="role-filter-trigger" className="w-[130px] flex-shrink-0">
      ...
      >
        <SelectTrigger data-e2e="party-filter-trigger" className="w-[120px] flex-shrink-0">
      ...
      >
        <SelectTrigger data-e2e="state-filter-trigger" className="w-[110px] flex-shrink-0">
