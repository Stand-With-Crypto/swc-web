...
const SMS_OPT_IN_CONSENT: Record<SupportedCountryCodes, string> = {
  ...
  [SupportedCountryCodes.GB]:
    'I authorize Stand With Crypto International Ltd and its service providers to contact me at this number via text (SMS) using automated dialing technology for cryptocurrency advocacy purposes. Message and data rates may apply. To opt-out at any time reply "STOP".',
