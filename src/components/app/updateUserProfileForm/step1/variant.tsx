        ...
        <div className="flex flex-col gap-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Input className="h-auto p-4" data-testid="first-name-input" placeholder="First name" {...field} />
                </FormControl>
                <FormErrorMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormControl>
                  <Input className="h-auto p-4" data-testid="last-name-input" placeholder="Last name" {...field} />
                </FormControl>
                <FormErrorMessage />
              </FormItem>
            )}
          ...
          {user.hasEmbeddedWallet || (
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input className="h-auto p-4" data-testid="email-address-input" placeholder="Email" {...field} />
                  </FormControl>
                  <FormErrorMessage />
                </FormItem>
              )}
