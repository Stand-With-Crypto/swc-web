  ...
  (
    ...
    return (
      <button
        ...
        {...rest}
      >
        <div className="bg-radial-gradient flex h-full w-full items-center justify-center rounded-br-3xl rounded-tr-3xl px-5 py-9 max-lg:order-2 lg:h-auto lg:min-h-48 lg:max-w-full lg:rounded-br-none lg:rounded-tl-3xl">
          <NextImage
            alt={title}
