...
export const dialogContentStyles = twNoop(
  'overflow-x-hidden overflow-y-auto fixed max-md:h-screen max-md:w-screen left-[50%] top-[50%] z-50 max-h-dvh lg:max-h-[90vh] w-11/12 md:w-full max-w-vw max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] md:rounded-3xl',
)
