...
export const dtsiPersonMockResolver = (): Partial<DTSI_Person> => {
  ...
  return {
    ...
    politicalAffiliationCategory: faker.helpers.arrayElement(
      Object.values(DTSI_PersonPoliticalAffiliationCategory),
    ),
    profilePictureUrl:
