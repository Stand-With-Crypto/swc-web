...
export default async function AboutPage(props: PageProps<{ language: SupportedLanguages }>) {
  const { countryCode, language } = await props.params

  const content = await getPageContent(PAGE_MODEL, PATHNAME, countryCode, language)
