...
async function callActionsByDTSISlug() {
  ...
  xlsx.utils.book_append_sheet(workbook, worksheet, `Call By User State - ${daysOfData} Days`)
  await xlsx.writeFile(workbook, './src/bin/localCache/callActionsByUserState.xlsx')
}

void runBin(callActionsByDTSISlug)
